...
<body>
	<style type="text/css">
		...
		<div class="tg-wrap">
			...
			<table width="100%">
				<tr>
					<td align="left">UNIT ORGANISASI: KEMENTERIAN KOODINATOR BIDANG PEREKONOMIAN</td>
					<td align="right">TGL PROSES: 29-8-2016</td>
				</tr>
			</table>
			...
			<table class="tg" style="margin-top: 20px;">
				<tr>
					...
					<th class="tg-hgcj" rowspan="2">PERINGKAT<br>JABATAN</th>
					<th class="tg-9hbo" style="text-align: left;" rowspan="2">
						<ul>
							<li>A. GAJI POKOK</li>
							<li>B. TJ. STRUK/FUNGS/UMUM</li>
							<li>C. GAJI KOTOR</li>
						</ul>
					</th>
					<th class="tg-9hbo" style="text-align: left;" rowspan="2">D. T. KINERJA<br>E. T. PENYESUAIAN PENGHASILAN<br>F. TJ. T. KHUSUS<br>G. POT ABSEN (%)</th>
					<th class="tg-9hbo" style="text-align: left;" rowspan="2">H. T. KINERJA BERSIH (D+E+F-G)<br>I. TJ. PPH 21<br>J. T. KINERJA KOTOR (H+1)<br>K. POT PPH 21</th>
					<th class="tg-9hbo" style="text-align: left;" rowspan="2">T. KINERJA YANG DIBAYARKAN (J-K)</th>
